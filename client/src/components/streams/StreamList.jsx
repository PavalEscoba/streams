    ...
    return (
      <ul className="list-group">
        {this.props.streams.map((stream) => {
          return (
            <li key={stream.title} className="list-group-item d-flex align-items-center">
              <i className="fa fa-video-camera text-secondary me-3" aria-hidden="true" style={{fontSize: 32 }}></i>
